function generatePDF(routinePair) {
    try {
        ...
        // Add subtitle
        doc.setFontSize(16);
        doc.text(`Sleep Routine for ${routinePair.childAge} year old${routinePair.childGender ? ` (${routinePair.childGender})` : ''}`, 105, 30, { align: "center" });
        ...
        // Save the PDF
        doc.save(`cozy-routine-${routinePair.childAge}yo-${new Date().toISOString().split('T')[0]}.pdf`);
    } catch (error) {
        reportError(error);
